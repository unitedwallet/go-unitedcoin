 ...
 * For HID-only devices, a previous self-contained package was created at [`github.com/karalabe/hid`](https://github.com/karalabe/hid), which worked well for hardware wallet uses cases in [`go-unitedcoin`](https://github.com/youfund/go-unitedcoin). It's a simple package that does it's thing well.
