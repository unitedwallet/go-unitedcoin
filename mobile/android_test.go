...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for go-unitedcoin issue #14599.
...
func TestAndroid(t *testing.T) {
	...
	for _, dir := range []string{"src/main", "src/androidTest/java/org/youfund/gethtest", "libs"} {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/youfund/go-unitedcoin/mobile")
