...
var (
	...
	consoleCommand = cli.Command{
		...
		Description: `
The Gun console is an interactive shell for the JavaScript runtime environment
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://github.com/youfund/go-unitedcoin/wiki/JavaScript-Console.`,
	}
...
JavaScript API. See https://github.com/youfund/go-unitedcoin/wiki/JavaScript-Console`,
	}
)
...
func remoteConsole(ctx *cli.Context) error {
	...
	if endpoint == "" {
		...
		endpoint = fmt.Sprintf("%s/gun.ipc", path)
	}
