...
The signer will generate a new private key, encrypts it according to [web3 keystore spec](https://github.com/youfund/wiki/wiki/Web3-Secret-Storage-Definition) and stores it in the keystore directory.
...
#### Arguments
  - content type [string]: type of signed data
     ...
     - `application/clique`: [clique](https://github.com/youfund/EIPs/issues/225) headers
...
#### Sign data
   Signs a chunk of structured data conformant to [EIP712]([EIP-712](https://github.com/youfund/EIPs/blob/master/EIPS/eip-712.md)) and returns the calculated signature.
...
#### Arguments
  - account [object]: key in [web3 keystore format](https://github.com/youfund/wiki/wiki/Web3-Secret-Storage-Definition) (retrieved with account_export)
...
#### Result
  - exported key, see [web3 keystore format](https://github.com/youfund/wiki/wiki/Web3-Secret-Storage-Definition) for
  more information
