...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/youfund/go-unitedcoin/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-unitedcoin authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-unitedcoin Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-unitedcoin"
	}
	if startOfSentence {
		return "The go-unitedcoin library"
	}
	return "the go-unitedcoin library"
}
