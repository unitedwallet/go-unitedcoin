...
// This test reproduces https://github.com/youfund/go-unitedcoin/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-unitedcoin-test-ipc-%d-%d", os.Getpid(), rand.Int63())
