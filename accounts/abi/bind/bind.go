...
//
// Detailed usage document and tutorial available on the go-unitedcoin Wiki page:
// https://github.com/youfund/go-unitedcoin/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
